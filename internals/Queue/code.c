...
Object Queue_Init(Object _self)
{
	...
	ASSERT_C ( "Queue:Init --- Checking for correct object type failed.", _self->gid ==  5026058259973625856ull )
...
Object Queue_Push(Object _self, Object _object)
{
	...
	ASSERT_C ( "Queue:Push --- Checking for correct object type failed.", _self->gid ==  5026058259973625856ull )
...
Object Queue_Pop(Object _self)
{
	...
	ASSERT_C ( "Queue:Pop --- Checking for correct object type failed.", _self->gid ==  5026058259973625856ull )
...
Object Queue_PopIfNotEmpty(Object _self)
{
	...
	ASSERT_C ( "Queue:PopIfNotEmpty --- Checking for correct object type failed.", _self->gid ==  5026058259973625856ull )
...
Object Queue_Remove(Object _self)
{
	...
	ASSERT_C ( "Queue:Remove --- Checking for correct object type failed.", _self->gid ==  5026058259973625856ull )
...
Object Queue_RemoveIfNotEmpty(Object _self)
{
	...
	ASSERT_C ( "Queue:RemoveIfNotEmpty --- Checking for correct object type failed.", _self->gid ==  5026058259973625856ull )
	if((Queue_Empty(_self)) != _false)
	{
		Object toReturn = _nil;
...
Object Queue_Peek(Object _self)
{
	...
	ASSERT_C ( "Queue:Peek --- Checking for correct object type failed.", _self->gid ==  5026058259973625856ull )
...
Object Queue_Empty(Object _self)
{
	...
	ASSERT_C ( "Queue:Empty --- Checking for correct object type failed.", _self->gid ==  5026058259973625856ull )
...
Object Queue_Destroy(Object _self)
{
	...
	ASSERT_C ( "Queue:Destroy --- Checking for correct object type failed.", _self->gid ==  5026058259973625856ull )
...
Object Queue_GetList(Object _self)
{
	...
	ASSERT_C ( "Queue:GetList --- Checking for correct object type failed.", _self->gid ==  5026058259973625856ull )
...
Object Queue_Clone(Object _self)
{
	...
	ASSERT_C ( "Queue:Clone --- Checking for correct object type failed.", _self->gid ==  5026058259973625856ull )
	Object _toReturn;
