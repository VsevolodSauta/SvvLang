...
Object MultiSet_Init(Object _self)
{
	...
	ASSERT_C ( "MultiSet:Init --- Checking for correct object type failed.", _self->gid ==  8253887558225682432ull )
...
Object MultiSet_Destroy(Object _self)
{
	...
	ASSERT_C ( "MultiSet:Destroy --- Checking for correct object type failed.", _self->gid ==  8253887558225682432ull )
...
Object MultiSet_Clone(Object _self)
{
	...
	ASSERT_C ( "MultiSet:Clone --- Checking for correct object type failed.", _self->gid ==  8253887558225682432ull )
	Object _toReturn;
...
Object MultiSet_Push(Object _self, Object _object)
{
	...
	ASSERT_C ( "MultiSet:Push --- Checking for correct object type failed.", _self->gid ==  8253887558225682432ull )
...
Object MultiSet_Contains(Object _self, Object _object)
{
	...
	ASSERT_C ( "MultiSet:Contains --- Checking for correct object type failed.", _self->gid ==  8253887558225682432ull )
...
Object MultiSet_RemoveOnce(Object _self, Object _object)
{
	...
	ASSERT_C ( "MultiSet:RemoveOnce --- Checking for correct object type failed.", _self->gid ==  8253887558225682432ull )
...
Object MultiSet_RemoveEvery(Object _self, Object _object)
{
	...
	ASSERT_C ( "MultiSet:RemoveEvery --- Checking for correct object type failed.", _self->gid ==  8253887558225682432ull )
...
Object MultiSet_Empty(Object _self)
{
	...
	ASSERT_C ( "MultiSet:Empty --- Checking for correct object type failed.", _self->gid ==  8253887558225682432ull )
