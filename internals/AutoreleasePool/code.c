...
Object AutoreleasePool_Init(Object _self)
{
	...
	ASSERT_C ( "AutoreleasePool:Init --- Checking for correct object type failed.", _self->gid ==  6558146264612776960ull )
...
Object AutoreleasePool_Dump(Object _self)
{
	...
	ASSERT_C ( "AutoreleasePool:Dump --- Checking for correct object type failed.", _self->gid ==  6558146264612776960ull )
	Object _list;
...
Object AutoreleasePool_Depth(Object _self)
{
	...
	ASSERT_C ( "AutoreleasePool:Depth --- Checking for correct object type failed.", _self->gid ==  6558146264612776960ull )
...
Object AutoreleasePool_PushFrame(Object _self)
{
	...
	ASSERT_C ( "AutoreleasePool:PushFrame --- Checking for correct object type failed.", _self->gid ==  6558146264612776960ull )
	Object _toPush;
	_toPush = List_Create();
...
Object AutoreleasePool_PopFrame(Object _self)
{
	...
	ASSERT_C ( "AutoreleasePool:PopFrame --- Checking for correct object type failed.", _self->gid ==  6558146264612776960ull )
...
Object AutoreleasePool_Add(Object _self, Object _object)
{
	...
	ASSERT_C ( "AutoreleasePool:Add --- Checking for correct object type failed.", _self->gid ==  6558146264612776960ull )
...
Object AutoreleasePool_Destroy(Object _self)
{
	...
	ASSERT_C ( "AutoreleasePool:Destroy --- Checking for correct object type failed.", _self->gid ==  6558146264612776960ull )
...
Object AutoreleasePool_Clone(Object _self)
{
	...
	ASSERT_C ( "AutoreleasePool:Clone --- Checking for correct object type failed.", _self->gid ==  6558146264612776960ull )
	Object toReturn = _self;
...
Object AutoreleasePool_DeepClone(Object _self)
{
	...
	ASSERT_C ( "AutoreleasePool:DeepClone --- Checking for correct object type failed.", _self->gid ==  6558146264612776960ull )
	Object toReturn = _self;
