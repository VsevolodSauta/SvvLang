...
ProcessorCommandSystem <Object> GetNamedEntityFromToDoOrStack <List> entityName <ListMap> toDo
	object = (((toDo At entityName) DynamicallyClone) Autorelease)
	if object == nil
...
ProcessorCommandSystem CodeAddEntityToStack <ListMap> toDo
	self.helperStack Push (((toDo ObjectAt ("Значение")) DynamicallyClone) Autorelease)
	return self


ProcessorCommandSystem CodeDuplicateTopInStack <ListMap> toDo
	self.helperStack Push (((self.helperStack Peek) DynamicallyClone) Autorelease)
	return self
